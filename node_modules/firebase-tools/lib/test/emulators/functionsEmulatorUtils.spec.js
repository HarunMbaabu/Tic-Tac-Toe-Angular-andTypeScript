...
describe("FunctionsEmulatorUtils", () => {
    ...
    describe("trimFunctionPath", () => {
        it("should remove the beginning of a function URL", () => {
            chai_1.expect(functionsEmulatorUtils_1.trimFunctionPath("/projectid/us-central1/functionPath")).to.equal("");
        });
        it("should not care about leading slashes", () => {
            chai_1.expect(functionsEmulatorUtils_1.trimFunctionPath("projectid/us-central1/functionPath")).to.equal("");
        });
        it("should preserve query parameters", () => {
            chai_1.expect(functionsEmulatorUtils_1.trimFunctionPath("/projectid/us-central1/functionPath?foo=bar")).to.equal("?foo=bar");
        });
        it("should preserve subpaths", () => {
            chai_1.expect(functionsEmulatorUtils_1.trimFunctionPath("/projectid/us-central1/functionPath/x/y")).to.equal("x/y");
        });
        it("should preserve subpaths with query parameters", () => {
            chai_1.expect(functionsEmulatorUtils_1.trimFunctionPath("/projectid/us-central1/functionPath/x/y?foo=bar")).to.equal("x/y?foo=bar");
        });
    });
});
